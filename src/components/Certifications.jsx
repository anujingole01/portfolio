...
const HolographicCard = ({ cert, index }) => {
    ...
    return (
        ...
        >
            <div className="absolute inset-0 bg-[#161616] rounded-2xl shadow-xl overflow-hidden border border-[#2A2A2A] transform-gpu transition-all duration-300 group-hover:border-[#0ea5e9]/50 group-hover:shadow-[0_0_30px_rgba(255,122,0,0.15)]">
                ...
                <div className="relative z-10 h-full p-8 flex flex-col justify-between">
                    <div className="flex items-start justify-between">
                        <div className="w-14 h-14 bg-[#1C1C1C] rounded-full flex items-center justify-center text-[#0ea5e9] border border-[#2A2A2A] group-hover:scale-110 transition-transform shadow-lg">
                            <FaAward size={28} />
                        </div>
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-white mb-2 line-clamp-2 leading-tight group-hover:text-[#0ea5e9] transition-colors">
                            {cert.title}
                        </h3>
                    ...
                    <div className="pt-5 border-t border-[#2A2A2A] flex justify-end">
                        {cert.link && cert.link !== '#' && (
                            <a
                                ...
                                className="flex items-center space-x-2 text-sm text-gray-500 hover:text-[#0ea5e9] transition-colors font-medium"
                            >
        ...
        <section id="certifications" className="py-24 relative overflow-hidden bg-[#0C0C0C]">
            ...
            <div className="max-w-[1300px] mx-auto px-8 md:px-16 w-full relative z-10">
                <div className="text-center mb-16">
                    <span className="text-[#0ea5e9] text-sm font-semibold tracking-widest uppercase block mb-2">Qualifications</span>
                    <motion.h2
