            ...
            <div className="max-w-[1300px] mx-auto px-8 md:px-16 w-full relative z-10">
                ...
                <div className="mb-16 flex flex-col md:flex-row items-center justify-between">
                    ...
                    <motion.p 
                        ...
                        viewport={{ once: true }}
                        className="mt-6 md:mt-0 text-gray-400 text-base max-w-lg leading-relaxed text-left md:text-right border-l-2 md:border-l-0 md:border-r-2 border-[#0ea5e9]/50 pl-4 md:pl-0 md:pr-4"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {GraphicProjects.map((project, index) => (
                        <motion.div
                            ...
                            className="group relative h-[380px] rounded-[2rem] overflow-hidden shadow-2xl transition-all duration-500 bg-[#161616] border border-[#2A2A2A] hover:border-[#0ea5e9]/40 cursor-pointer"
                        >
                            {/* Image Background */}
                            <img
                                src={project.img}
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-8 flex flex-col justify-end h-full z-10">
                                ...
                                <div className="relative z-20 translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                                    ...
                                    <h3 className="text-sm font-semibold text-[#0ea5e9] uppercase tracking-widest mb-1">{project.category}</h3>
                                    ...
                                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-150 mt-4">
                                        <div className="h-0.5 w-12 bg-[#0ea5e9] rounded-full"></div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
