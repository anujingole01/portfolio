        ...
        <section id="home" className="w-full h-full min-h-[85vh] flex items-center pt-8 md:pt-0 overflow-hidden relative">
            ...
            <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12 lg:px-20 flex flex-col-reverse md:flex-row items-center justify-between">
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="text-3xl md:text-5xl font-bold text-[#0ea5e9] mb-8 leading-tight tracking-tight h-16 md:h-20 flex items-center">
                    ...
                    <motion.div variants={itemVariants} className="flex space-x-5 mb-12">
                        {[
                            ...
                            <motion.a 
                                ...
                                target="_blank"
                                rel="noreferrer"
                                whileHover={{ scale: 1.15, backgroundColor: "#0ea5e9", borderColor: "#0ea5e9", y: -4 }}
                                whileTap={{ scale: 0.95 }}
                                className="w-14 h-14 rounded-full border-2 border-gray-600 flex items-center justify-center text-gray-300 hover:text-white transition-all duration-300 shadow-lg hover:shadow-[#0ea5e9]/50"
                            >
                                {social.icon}
                            </motion.a>
                        ))}
                    ...
                    <motion.div 
                        variants={itemVariants}
                        className="bg-[#1C1C1C] border border-[#2A2A2A] rounded-2xl w-full max-w-2xl p-6 lg:p-8 flex items-center justify-between shadow-2xl hover:border-[#0ea5e9]/40 transition-colors duration-300"
                    >
                        ...
                        <div className="w-px h-16 bg-gray-700 mx-2 md:mx-6 shadow-[0_0_10px_rgba(255,122,0,0.2)]"></div>
                        <div className="flex flex-col text-center md:text-left">
                            <h3 className="text-[#0ea5e9] text-3xl md:text-4xl font-black mb-1">3+</h3>
                ...
                >
                    <div className="relative w-[320px] h-[320px] sm:w-[420px] sm:h-[420px] lg:w-[480px] lg:h-[480px]">
                        ...
                        <motion.div 
                            ...
                            className="relative w-full h-full m-auto rounded-full overflow-hidden border-2 border-[#2A2A2A] shadow-[0_0_60px_rgba(255,122,0,0.1)] hover:shadow-[0_0_80px_rgba(255,122,0,0.25)] ring-4 ring-transparent hover:ring-[#0ea5e9]/20 flex justify-center items-center transition-all duration-500"
                        >
                            <img 
                                src={profilePic}
                                alt="Profile" 
